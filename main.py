...
class Costumer:
    def __init__(self):
        ...
        self.costumer_window.config(bg="light green")
        self.lbl=Label(self.costumer_window,text="Costumer Data Handling Menu",width=29,font="Times 30 bold",fg="white",bg="green",bd=10)
        self.lbl.grid(row=0,column=0,pady=20)
        self.label_frame=t.LabelFrame(self.costumer_window,foreground="white",background="light green",bd=5)
    ...
    def view(self):
        ...
        if not fileexist_c:
            messagebox.showerror(parent=self.costumer_window,title="Error",message="Costumers File Not Found")
    ...
    def submit(self):
        if (self.na_entrybox.get()).upper() =="":
            ...
            with open("costumers.csv","a",newline="") as f:
                csv_writer=DictWriter(f,fieldnames=["Costumer Name","Address","State","TIN/GST no","Transport","Phone","GST","Date"])
                if not file_exists:
                ...
                if self.na_entrybox.get().upper() in c_name:
                    messagebox.showerror(parent=self.add_window,title="Error",message="Name Already Exist")
                else:
                    csv_writer.writerow({
                    "Costumer Name":(self.na_entrybox.get()).upper(),
                    ...
                    messagebox.showinfo(parent=self.add_window,title="Succesfull",message="Account Saved Successfully")
...
class Update(Add):
    def __init__(self):
        ...
        self.update_window.config(bg="light green")
        self.lbl=Label(self.update_window,text="Enter The Details of Account",font="Times 30 bold ",fg="white",bg="green",bd=10,width=29)
        self.lbl.grid(row=2,column=0,pady=20)
        self.lab_frame=LabelFrame(self.update_window,foreground="white",background="light green",bd=0)
        self.lab_frame.grid(row=3,column=0)
        self.name_label=Label(self.lab_frame,text="Costumer Name:",bg="green",fg="white",font="consolas 15 ",width=15)
        ...
        self.update_button=t.Button(self.lab_frame,width= 10,text="Update",command=self.choice,background="green",foreground="white",font="consolas 13",bd=3)
        self.update_button.grid(row=4,column=0,pady=20)
        self.del_button=t.Button(self.lab_frame,width= 10,text="Delete",command=self.delete,background="green",foreground="white",font="consolas 13",bd=3)
        self.del_button.grid(row=4,column=1,padx=40,pady=20)
        self.back_button=t.Button(self.lab_frame,width= 10,text="Back",command=self.update_window.destroy,background="green",foreground="white",font="consolas 13",bd=3)
        ...
        if messagebox.askyesno(parent=self.update_window,title="Update Account",message="Are You Sure?"):
            ...
            with open("costumers.csv","r") as f:
                ...
                if flag==True:
                    ...
                    super().__init__('lightgreen','green')
        ...
        if messagebox.askyesno(parent=self.update_window,title="Delete Account",message="Are You Sure?"):
            ...
            with open("costumers.csv","w",newline="") as f1:
                ...
                for line in full_data:
                    wo.writerow(line)
            if flag==True:
                messagebox.showinfo(parent=self.update_window,title="Success",message="Acount Delete Successfully")
                self.update_window.destroy()
            else:
                messagebox.showerror(parent=self.update_window,title="Error",message="Not Found")
                self.name_entry.delete(0,END)
    ...
    def go(self,event):
        if self.name_entry.get()=="":
            Shortcuts_menu.cost_n(self.name_entry,"costumers.csv","View All Costumers Name            Esc->Exit",["Costumer Name","Address","State","TIN/GST no","Transport","Phone","GST","Date"],7,0,self.update_window,'lightgreen','green')
        else:
            self.choice()
#**********************************************************ITEM*************************
class Item:
    def __init__(self):
        ...
        self.item_window.config(bg="coral")
        self.lbl=Label(self.item_window,text="Item Master",width=29,font="Times 30 bold",fg="white",bg="brown",bd=10)
        self.lbl.grid(row=0,column=0,pady=20)
        self.label_frame=t.LabelFrame(self.item_window,foreground="white",background="coral",bd=5)
...
class Add_Item:
    def __init__(self):
        ...
        self.add_item_window.config(bg="coral")
        self.lbl=Label(self.add_item_window,text="Add Item Details Here",width=29,font="Times 30 bold",fg="white",bg="brown",bd=10)
        self.lbl.grid(row=0,column=0,pady=20)
        self.frame1=LabelFrame(self.add_item_window,foreground="white",background="coral",bd=0)
        self.frame1.grid(row=1,column=0,pady=5)
        self.labels=["Discription","Size","Net Rate","M.R.P","Quantity","Type","Discount %"]
        for i in range(len(self.labels)):
            self.cur_label="label"+str(i)
            self.cur_label=t.Label(self.frame1,text=self.labels[i],bg="brown",fg="white",font="consolas 16",width=15)
            self.cur_label.grid(row=i,column=0,sticky=t.W,pady=10)
        ...
        self.save_=Button(self.frame1,text="Save",width=10,bd=4,command=self.save,font="consolas 14 bold",bg="brown",fg="white")
        self.save_.grid(row=8,column=0,pady=10)
        self.back=Button(self.frame1,text="Back",width=10,command=self.add_item_window.destroy,bd=4,font="consolas 14 bold",bg="brown",fg="white")
    ...
    def save(self):
        if (self.disc.get()).upper() =="":
            ...
            with open("items.csv","a",newline="") as f:
                csv_writer=DictWriter(f,fieldnames=["Discription","Size","Net Rate","M.R.P","Quantity","Type","Discount","Date of item saved"])
                if not file_exists:
                    csv_writer.writeheader()
                ...
                if (self.disc.get()).upper() in i_name:
                    messagebox.showerror(parent=self.add_item_window,title="Error",message="Item Already Exist")
                else:
                    csv_writer.writerow({
                    "Discription":(self.disc.get()).upper(),
                    ...
                    messagebox.showinfo(parent=self.add_item_window,title="Successfull",message="item Saved")
...
class Update_item(Add_Item):
    def __init__(self):
        ...
        self.update_item_window.config(bg="coral")
        self.lbl=Label(self.update_item_window,text="Enter The Details of Item",width=29,font="Times 30 bold ",fg="white",bg="brown",bd=10)
        self.lbl.grid(row=2,column=0,pady=20)
        self.lab_frame=LabelFrame(self.update_item_window,foreground="white",background="coral",bd=0)
        self.lab_frame.grid(row=3,column=0)
        self.name_label=Label(self.lab_frame,text="Item Name:",bg="brown",fg="white",font="consolas 15 ",width=15)
        self.name_label.grid(row=0,column=0,padx=10,pady=10,sticky=t.W)
        self.name_entry=Entry(self.lab_frame,width=15,font="consolas 15",bd=0)
        self.name_entry.grid(row=0,column=1,pady=10,padx=10)
        self.name_entry.focus()
        self.name_entry.bind("<Return>",self.go)
        self.update_button=t.Button(self.lab_frame,width= 10,text="Update",command=self.choice,background="brown",foreground="white",font="consolas 13",bd=2)
        self.update_button.grid(row=4,column=0,pady=10)
        self.del_button=t.Button(self.lab_frame,width= 10,text="Delete",command=self.delete,background="brown",foreground="white",font="consolas 13",bd=2)
        self.del_button.grid(row=4,column=1,padx=40,pady=10)
        self.back_button=t.Button(self.lab_frame,width= 10,text="Back",command=self.update_item_window.destroy,background="brown",foreground="white",font="consolas 13",bd=2)
    ...
    def go(self,event):
        if self.name_entry.get()=="":
            Shortcuts_menu.cost_n(self.name_entry,"items.csv","View All Items Name            Esc->Exit",["Discription","Size","Net Rate","M.R.P","Quantity","Type","Discount","Date of item saved"],4,0,self.update_item_window,'coral','brown')
        else:
            self.choice()
#**************************************INVOICE**************************
...
class Invoice:
    def __init__(self):
        ...
        self.invoice_window.config(bg="lavender")
        self.lbl=Label(self.invoice_window,text="Invoice Data Handling Menu",font="Times 30 bold",width=29,fg="white",bg="brown",bd=10)
        self.lbl.grid(row=0,column=0,pady=10)
        self.label_frame=t.LabelFrame(self.invoice_window,foreground="white",background="lavender",bd=5)
        self.label_frame.grid(row=1,column=0,pady=10)
    ...
    def delete_bind(self,event):
        self.delete()
    def print(self):
        Invoice_Print('lavender','brown')
    def print_bind(self,event):
        self.print()
    def summary(self):
        Invoice_summary('lavender','brown')
    def summary_bind(self,event):
        self.summary()
    def register(self):
        Day_Register('lavender','brown')
...
class Invoice_Add:
    def __init__(self):
        ...
        self.add_inv.config(bg="lavender")
        self.lab=Label(self.add_inv,text="Invoice Bills ",font="Times 30 bold",bg="brown",fg="white",bd=1)
        self.lab.grid(row=0,column=0,pady=10)
        self.inv_frame1=LabelFrame(self.add_inv,bg="lavender",bd=0)
        self.inv_frame1.grid(row=1,column=0)
        self.inv_no=Label(self.inv_frame1,text="Invoice no",bg="brown",fg="white",width=10,font="consolas 13")
        ...
        self.date=Label(self.inv_frame1,text="Date",bg="brown",fg="white",width=10,font="consolas 13")
        self.date.grid(row=1,column=0,pady=5,padx=10)
        self.date_ent=Entry(self.inv_frame1,width=10,fg="black",font="consolas 15",bd=0,bg="lavender")
        ...
        self.cost=Label(self.inv_frame1,text="Costumer",bg="brown",fg="white",width=10,font="consolas 13")
        self.cost.grid(row=2,column=0,pady=5,padx=10)
        self.cost_ent=Entry(self.inv_frame1,width=15,fg="black",font="consolas 15",bd=0,bg="lavender")
        self.cost_ent.grid(row=2,column=1,pady=10)
        self.cost_ent.focus_force()
        self.cost_ent.bind("<Return>",self.go2)
        self.view=Button(self.inv_frame1,text="View All Costumers Name",font="consolas 12",command=self.view_name,bg="brown",fg="white",bd=0)
        self.view.grid(row=2,column=2,pady=10,padx=20)
        self.inv_frame2=LabelFrame(self.add_inv,bg="lavender",bd=0)
        self.inv_frame2.grid(row=3,column=0,padx=10)
        self.labels=["Item Discription","Quantity","Rate","Amount"]
        for i in range(len(self.labels)):
            self.cur_label="label"+str(i)
            self.cur_label=t.Label(self.inv_frame2,text=self.labels[i],bg="green",fg="white",font="consolas 13",width=15)
            self.cur_label.grid(row=0,column=i)
        self.itm=Entry(self.inv_frame2,width=15,font="consolas 15 bold",bg="lavender",bd=0)
        self.itm.grid(row=1,column=0)
        self.itm.bind("<Return>",self.go3)
        self.itm.bind("<Down>",self.fini)
        self.quant=Entry(self.inv_frame2,width=10,font="consolas 13",bg="lavender",bd=0)
        ...
        self.rate=Entry(self.inv_frame2,width=10,font="consolas 13",bg="lavender",bd=0)
        ...
        self.amount=Entry(self.inv_frame2,width=10,font="consolas 13",bg="lavender",bd=0)
        self.amount.grid(row=1,column=3,padx=10)
        self.viewitm=Button(self.inv_frame2,text="View All Items Name",font="consolas 11",command=self.view_item,bg="green",fg="white",bd=0)
        self.viewitm.grid(row=0,column=4,pady=20,padx=20)
        self.done=Button(self.inv_frame2,text="Add to Cart",width=17,command=self.done_itm,font="consolas 12",bg="green",fg="white",bd=0)
        self.done.grid(row=1,column=4,padx=10)
        self.done.bind("<Return>",self.go6)
        self.inv_frame3=LabelFrame(self.add_inv,width=750,height=220,bg="light green",bd=1)
        self.inv_frame3.grid(row=4,column=0,padx=5,pady=10)
        self.lab=Label(self.inv_frame3,text="Cart",width=80,font="consolas 13",bg="green",fg="white")
        self.lab.grid(row=0,column=0)
        self.lab2=Label(self.inv_frame3,text="Max Size 5 items",width=80,font="consolas 13",bg="green",fg="white")
        self.lab2.grid(row=6,column=0)
        self.inv_frame4=LabelFrame(self.add_inv,bg="lavender",bd=0)
    ...
    def done_itm(self):
        if self.itm.get().upper() == "":
            messagebox.showerror(parent=self.add_inv,title="Error",message="Please Add Item discription")
            ...
            if self.data[0] not in items_name:
                ...
                if self.sno==6:
                    ...
                    self.tot=Label(self.inv_frame4,text="Total",bg="green",width=10,fg="white",bd=0,font="consolas 13")
                    self.tot.grid(row=0,column=0)
                    self.tot_q=Entry(self.inv_frame4,fg="black",width=10,font="consolas 13 bold",bd=0,bg="lavender")
                    self.tot_q.insert(END,self.total_quantity)
                    self.tot_q.configure(state="readonly")
                    self.tot_q.grid(row=0,column=1,padx=10)
                    self.tot_a=Entry(self.inv_frame4,fg="black",width=12,font="consolas 13 bold",bd=0,bg="lavender")
                    self.tot_a.insert(END,self.total_amount)
                    self.tot_a.configure(state="readonly")
                    self.tot_a.grid(row=0,column=2,padx=10)
                    self.fin=Button(self.inv_frame4,text="Finish",bd=0,command=self.finish,font="consolas 13",bg="green",fg="white")
    ...
    def finish(self):
        self.fin_w=Label(self.inv_frame4,bd=0,bg="lavender",width=12,height=2)
        self.fin_w.grid(row=0,column=3)
        self.pc=Label(self.inv_frame4,text="Pack/Frt",font="consolas 13",width=10,bg="green",fg="white",bd=0)
        ...
        self.tax=Label(self.inv_frame4,text="Tax",font="consolas 13",width=10,bg="green",fg="white",bd=0)
        ...
        self.trans=Label(self.inv_frame4,text="Transport",font="consolas 13",width=10,bg="green",fg="white",bd=0)
        ...
        self.way=Label(self.inv_frame4,text="Way Bill",font="consolas 13",width=10,bg="green",fg="white",bd=0)
        ...
        self.order=Label(self.inv_frame4,text="Order No",font="consolas 13",width=10,bg="green",fg="white",bd=0)
    ...
    def go13(self,event):
        self.finish()
    def view_name(self):
        Shortcuts_menu.cost_n(self.cost_ent,"costumers.csv","View All Costumers Name            Esc->Exit",["Costumer Name","Address","State","TIN/GST no","Transport","Phone","GST","Date"],7,0,self.add_inv,'lavender','brown')
    def view_item(self):
        Shortcuts_menu.cost_n(self.itm,"items.csv","View All Items Name            Esc->Exit",["Discription","Size","Net Rate","M.R.P","Quantity","Type","Discount","Date of item saved"],4,0,self.add_inv,'lavender','brown')
    def go1(self,event):
        self.cost_ent.focus()
    def go2(self,event):
        if self.cost_ent.get().upper() !="":
            ...
            if not fileexist11:
                messagebox.showerror(parent=self.add_inv,title="Error",message="Costumers file  not found")
    ...
    def go11(self,event):
        self.save_final=Button(self.inv_frame4,text="save",command=self.save_final_func,width=10,bd=1,font="consolas 15",bg="green",fg="white")
        self.save_final.grid(row=4,column=3,pady=20)
        self.save_final.focus_force()
        self.save_final.bind("<Return>",self.go12)
        self.cancel=Button(self.inv_frame4,text="cancel",command=self.cancel_final,width=10,bd=1,font="consolas 15",bg="green",fg="white")
...
class Invoice_Delete:
    def __init__(self):
        ...
        self.inv_del.config(bg="lavender")
        self.lbl=Label(self.inv_del,text="Delete Invoice",font="Times 30 bold",width=29,fg="white",bg="brown",bd=10)
        self.lbl.grid(row=2,column=0,pady=10)
        self.in_frame=LabelFrame(self.inv_del,bd=0,bg="lavender")
        self.in_frame.grid(row=3,column=0)
        self.in_ab=Label(self.in_frame,text=' Invoice No ',bg="brown",fg="white",width=10,font="consolas 15")
        ...
        self.del_button=t.Button(self.in_frame,width= 10,text="Delete",command=self.choice,background="brown",foreground="white",font="consolas 13",bd=3)
        self.del_button.grid(row=4,column=1,padx=40,pady=10)
        self.back_button=t.Button(self.in_frame,width= 10,text="Back",command=self.inv_del.destroy,background="brown",foreground="white",font="consolas 13",bd=3)
        self.back_button.grid(row=4,column=2,padx=40,pady=10)
            ...
            if messagebox.askyesno(parent=self.inv_del,title="Delete Invoice",message="Are You Sure!!!"):
                ...
                with open("invoice_data.csv","r") as f:
                    ...
                    if flag==False:
                        ...
                        messagebox.showinfo(parent=self.inv_del,title="successfull",message=" Invoice Delete Successfully")
                        self.inv_del.destroy()
class Day_Register:
    def __init__(self,bgf,bgh):
        self.bgf=bgf
    ...
    def bind_c(self,event):
        if self.sale_combobox.get()=="PARTICULAR":
            self.name_l=Label(self.in_frame,text="Costumer Name",font="consolas 15",fg="white",bg=self.bgh,width=15)
    ...
    def cl(self,event):
        if self.name_e.get()=="":
            Shortcuts_menu.cost_n(self.name_e,"costumers.csv","View All Costumers Name            Esc->Exit",["Costumer Name","Address","State","TIN/GST no","Transport","Phone","GST","Date"],7,0,self.inv_day,self.bgf,self.bgh)
        else:
            self.choice()
    def choice(self):
        if self.name_e.get()=="":
...
class Invoice_summary:
    ...
    def open(self):
        if messagebox.askyesno(parent=self.sum_day,title="print PDF",message="Inoice Summary"):
...
class Report:
    def __init__(self):
        ...
        self.report_window.config(bg="lightsteelblue")
        self.lbl=Label(self.report_window,text="Stock Menu",width=29,font="Times 30 bold",fg="white",bg="steelblue",bd=10)
        self.lbl.grid(row=0,column=0,pady=10)
        self.label_frame=LabelFrame(self.report_window,foreground="white",background="lightsteelblue",bd=5)
        self.label_frame.grid(row=1,column=0,padx=30,pady=20)
        self.cr=Button(self.label_frame,text="Costumer Report",command=self.register,font="consolas 20 bold",bg="white",fg="black",)
    ...
    def register(self):
        Day_Register('lightsteelblue','steelblue')
    def register_bind(self,event):
        self.register()
    ...
    def tax_b(self,event):
        self.tax()
    def summary(self):
        Invoice_summary('lightsteelblue','steelblue')
...
class Item_Report:
    def __init__(self):
        ...
        self.ir_day.config(bg="lightsteelblue")
        self.lbl=Label(self.ir_day,text="Items Stock Register",width=29,font="Times 30 bold",fg="white",bg="steel blue",bd=10)
        self.lbl.grid(row=0,column=0,pady=10)
        self.in_frame=LabelFrame(self.ir_day,bd=0,bg="lightsteelblue")
        self.in_frame.grid(row=1,column=0,padx=10,pady=30)
        self.lbldf=Label(self.in_frame,text="Date from",font="consolas 15",fg="white",bg="steelblue",width=13)
        self.lbldf.grid(row=1,column=2,pady=10)
        self.lbl_dfe=Entry(self.in_frame,width=10,font="consolas 15",bg="lightsteelblue",fg="black",bd=0)
        self.lbl_dfe.grid(row=1,column=3,pady=10,padx=5)
        self.lbl_dfe.insert(END,"01/02/20")
        self.lbl_dfe.focus()
        self.lbl_dfe.bind("<Return>",self.open_)
        self.lbldt=Label(self.in_frame,text=" To Date",font="consolas 15",fg="white",bg="steelblue",width=13)
        self.lbldt.grid(row=1,column=4,pady=10,padx=25)
        self.lbl_dte=Entry(self.in_frame,width=10,font="consolas 15",bg="lightsteelblue",fg="black",bd=0)
        self.lbl_dte.grid(row=1,column=5,pady=10,padx=10)
        self.lbl_dte.insert(END,f"{date.today().strftime('%d/%m/%y')}")
        self.lbl_dte.configure(state="readonly")
        self.pr=Button(self.in_frame,width=10,text="Print",font="consolas 14",bg="steelblue",fg="white",command=self.open)
        self.pr.grid(row=2,column=3,pady=20)
        self.bck=Button(self.in_frame,width=10,text="Back",font="consolas 14",bg="steelblue",fg="white",command=self.ir_day.destroy)
        self.bck.grid(row=2,column=4,pady=20)
...
class Tax_Statement:
    def __init__(self):
        ...
        self.tx_day.config(bg="lightsteelblue")
        self.lbl=Label(self.tx_day,text="Tax Register",width=29,font="Times 30 bold",fg="white",bg="steelblue",bd=10)
        self.lbl.grid(row=0,column=0,pady=10)
        self.in_frame=LabelFrame(self.tx_day,bd=0,bg="lightsteelblue")
        self.in_frame.grid(row=1,column=0,padx=10,pady=30)
        self.lbldf=Label(self.in_frame,text="Date from",font="consolas 15",fg="white",bg="steelblue",width=13)
        self.lbldf.grid(row=1,column=2,pady=10)
        self.lbl_dfe=Entry(self.in_frame,width=10,font="consolas 15",bg="lightsteelblue",fg="black",bd=0)
        ...
        self.pr=Button(self.in_frame,width=10,text="Print",font="consolas 14",bg="steelblue",fg="white",command=self.open)
        self.pr.grid(row=2,column=3,pady=20)
        self.bck=Button(self.in_frame,width=10,text="Back",font="consolas 14",bg="steelblue",fg="white",command=self.tx_day.destroy)
        self.bck.grid(row=2,column=4,pady=20)
...
class Account:
    def __init__(self):
        ...
        self.acc_window.config(bg="lightsteelblue")
        self.lbl=Label(self.acc_window,text="Account Menu",width=29,font="Times 30 bold",fg="white",bg="steelblue",bd=10)
        self.lbl.grid(row=0,column=0,pady=10)
        self.label_frame=LabelFrame(self.acc_window,foreground="white",background="lightsteelblue",bd=5)
        self.label_frame.grid(row=1,column=0,padx=30,pady=20)
...
class Add_account:
    def __init__(self):
        ...
        self.add_ac_window.config(bg="lavender")
        self.lab=Label(self.add_ac_window,text="Add Voucher",bg="steelblue",fg="white",width=29,font="Times 30 bold",bd=10)
        self.lab.grid(row=0,column=0,pady=10)
        self.lf=LabelFrame(self.add_ac_window,bg="lavender",bd=0)
        self.lf.grid(row=1,column=0,pady=10)
        self.lab_vn=Label(self.lf,bg="green",text="Voucher No",width=14,fg="white",font="consolas 15")
        self.lab_vn.grid(row=1,column=1,pady=10)
        self.lab_vn_e=Entry(self.lf,font="consolas 15",bg="lavender",fg="black",bd=0)
        ...
        self.date=Label(self.lf,text="Date",bg="green",width=14,fg="white",font="consolas 15",bd=0)
        self.date.grid(row=2,column=1,padx=10,pady=10)
        self.lab_dt_e=Entry(self.lf,font="consolas 15",bg="lavender",fg="black",bd=0)
        ...
        self.lb_c=Label(self.lf,bg="green",text="Voucher Type",width=14,fg="white",font="consolas 15")
        ...
        self.lf2=LabelFrame(self.add_ac_window,bg="lavender",bd=0)
        self.lf2.grid(row=2,column=0,pady=10)
        self.party=Label(self.lf,text="Party Name",width=14,bg="green",fg="white",font="consolas 15",bd=0)
        self.party.grid(row=4,column=1,pady=10)
        self.party_e=Entry(self.lf,font="consolas 15 bold",bg="lavender",fg="black",bd=0)
        self.party_e.grid(row=4,column=2,pady=10)
        self.party_e.bind("<Return>",self.party_b)
        self.lf3=LabelFrame(self.lf2,bg="lavender",bd=2,width=450,height=270)
        self.lf3.grid(row=1,column=0,padx=20,pady=5)
        self.pal=Label(self.lf3,text=" Particulars",width=20,bg="steelblue",fg="white",font="consolas 15",bd=0)
        self.pal.grid(row=0,column=0)
        self.aml=Label(self.lf3,text="Amount",width=20,bg="steelblue",fg="white",font="consolas 15",bd=0)
        self.aml.grid(row=0,column=1)
        self.csh=Label(self.lf3,text="Cash/D.D",bg="steelblue",width=14,fg="white",font="consolas 15 bold",bd=5)
        self.csh.grid(row=1,column=0,pady=20)
        self.am_e=Entry(self.lf3,font="consolas 15 bold",width=15,bg="lavender",fg="black",bd=0)
        ...
        self.csh=Label(self.lf3,text="Narration",bg="steelblue",width=14,fg="white",font="consolas 15 bold",bd=5)
        self.csh.grid(row=2,column=0,pady=20)
        self.csh_e=Entry(self.lf3,font="consolas 14 bold",width=19,bg="lavender",fg="black",bd=0)
        self.csh_e.grid(row=2,column=1,pady=10)
        self.csh_e.insert(END,f"Based on Voch/Type")
        self.csh_e.configure(state="readonly")
        self.fr0=LabelFrame(self.add_ac_window,bg="lavender",bd=0)
        self.fr0.grid(row=3,column=0,pady=10)
        self.save=Button(self.fr0,width=7,command=self.final_save,text="Save",font="consolas 15 bold",bg="green",fg="white")
        self.save.grid(row=0,column=0)
        self.cancel=Button(self.fr0,width=7,command=self.add_ac_window.destroy,text="Cancel",font="consolas 15 bold",bg="green",fg="white")
    ...
    def party_b(self,event):
        if self.party_e.get()=="":
            Shortcuts_menu.cost_n(self.party_e,"costumers.csv","View All Costumers Name            Esc->Exit",["Costumer Name","Address","State","TIN/GST no","Transport","Phone","GST","Date"],7,0,self.add_ac_window,'lavender','steelblue')
        else:
            self.am_e.focus()
    def exit(self,event):
    ...
    def final_save(self):
        ...
        if mbox is True:
            ...
            messagebox.showinfo(parent=self.add_ac_window,title="successfull",message="Voucher Save successfully")
...
class Update_delete:
    def __init__(self):
        ...
        self.update_ac.config(bg="lightsteelblue")
        self.lbl=Label(self.update_ac,text="Enter The Details of Account",width=29,font="Times 30 bold ",fg="white",bg="steelblue",bd=10)
        self.lbl.grid(row=2,column=0,pady=20)
        self.lab_frame=LabelFrame(self.update_ac,foreground="white",background="lightsteelblue",bd=0)
        self.lab_frame.grid(row=3,column=0)
        self.name_label=Label(self.lab_frame,text="Voucher No:",bg="steelblue",fg="white",font="consolas 15 ",width=15)
        self.name_label.grid(row=0,column=1,padx=10,pady=10,sticky=t.W)
        self.name_entry=Entry(self.lab_frame,width=15,font="consolas 15",bd=0)
        self.name_entry.grid(row=0,column=2,pady=10,padx=10)
        self.name_entry.focus()
        self.name_entry.bind("<Return>",self.go)
        self.del_button=t.Button(self.lab_frame,width= 10,text="Delete",command=self.delete,background="steelblue",foreground="white",font="consolas 13",bd=3)
        self.del_button.grid(row=4,column=1,padx=40,pady=10)
        self.back_button=t.Button(self.lab_frame,width= 10,text="Back",command=self.update_ac.destroy,background="steelblue",foreground="white",font="consolas 13",bd=3)
        self.back_button.grid(row=4,column=2,padx=40,pady=10)
...
class Acc_day_Register:
    def __init__(self):
        ...
        self.lbl_dte.insert(END,f"{date.today().strftime('%d/%m/%y')}")
        self.lbl_dte.configure(state="readonly")
        self.sale_lbl=Label(self.in_frame,text="Party Name",font="consolas 15",fg="white",bg="steelblue",width=13)
        self.sale_lbl.grid(row=4,column=3,pady=30,padx=10)
        self.name_e=Entry(self.in_frame,width=15,font="consolas 15 bold",bg="white",fg="black",bd=0)
        self.name_e.grid(row=4,column=4)
        self.pr=Button(self.in_frame,width=10,text="Print",font="consolas 14",bg="steelblue",fg="white",command=self.pri)
        self.pr.grid(row=5,column=3)
        self.bck=Button(self.in_frame,width=10,text="Back",font="consolas 14",bg="steelblue",fg="white",command=self.acc_day.destroy)
    ...
    def name_b(self,event):
        if self.name_e.get()=="":
            Shortcuts_menu.cost_n(self.name_e,"costumers.csv","View All Costumers Name            Esc->Exit",["Costumer Name","Address","State","TIN/GST no","Transport","Phone","GST","Date"],7,0,self.acc_day,'lightsteelblue','steelblue')
        else:
            self.pri()
#***********************************billing****************************
class Billing:
    def __init__(self):
        ...
        self.billing_window.config(bg="lightgreen")
        self.lbl=Label(self.billing_window,text="Billing Menu",width=29,font="Times 30 bold",fg="white",bg="green",bd=10)
        self.lbl.grid(row=0,column=0,pady=10)
        self.label_frame=LabelFrame(self.billing_window,foreground="white",background="lightgreen",bd=5)
        self.label_frame.grid(row=1,column=0,padx=30,pady=20)
    ...
    def print(self):
        Invoice_Print('lightgreen','green')
    def print_b(self,event):
        self.print()
    def voucher(self):
        Credit_Reciept('lightgreen','green')
...
class Purchase:
    def __init__(self):
        ...
        self.purc_window.config(bg="lightsteelblue")
        self.lbl=Label(self.purc_window,text="Party Purchase Stock ",width=29,font="Times 30 bold",fg="white",bg="steelblue",bd=10)
        self.lbl.grid(row=0,column=0,pady=10)
        self.label_frame=LabelFrame(self.purc_window,foreground="white",background="lightsteelblue",bd=5)
        self.label_frame.grid(row=1,column=0,padx=30,pady=20)
