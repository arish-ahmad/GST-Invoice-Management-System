...
def pdf_func(invoice_name,no):
    ...
    def cart_filling(e):
        ...
        for i in range(1,e):
            ...
            pdfile.drawString(206,y,"6203")        #hsn no
    ...
    pdfile.setFont("Times-Bold",55)
    pdfile.drawString(110,67,"Altaf Enterprises")
    pdfile.setFont("Courier-Oblique",11)
    pdfile.drawString(145,90,"Denim,Non Denim,Cargo Ladies & Gents jeans")
    f=[]
    Frame(20,100,198,40,showBoundary=1).addFromList(f,pdfile)
    pdfile.setFont("Helvetica-Bold",12)
    pdfile.drawString(10,115,"     GSTIN:07AXYPK8042K1ZP")
    pdfile.drawString(10,130,"     PAN:AXYPK8042K")
    Frame(218,100,235,40,showBoundary=1).addFromList(f,pdfile)
    pdfile.setFont("Helvetica",12)
    pdfile.drawString(200,115,"            NEW F-130,Raghubir Nagar,")
    pdfile.drawString(205,130,"                   New Delhi-110 027")
    Frame(453,100,120,40,showBoundary=1).addFromList(f,pdfile)
    pdfile.drawString(425,115,"           Ph:9711335668")
    pdfile.drawString(429,130,"               8920046546")
    ...
    pdfile.drawString(35,718,"A/C-629305040440")
    pdfile.drawString(35,734,"IFSC-ICIC0006293")
    ...
    pdfile.drawString(22,820,"3) All Disputes are subjects to Delhi Jurisdictions.")
    pdfile.setFont("Helvetica",9)
    pdfile.drawString(300,759,"     Certified that the particulars given above are true & Correct")
    pdfile.drawString(300,775,"         For")
    pdfile.setFont("Helvetica-Bold",12)
    pdfile.drawString(330,775,"    Altaf Enterprises")
